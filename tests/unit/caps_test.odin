...
test_caps_force_compat :: proc(t: ^testing.T) {
	ui.caps_init("compat")
	testing.expect_value(t, ui.caps.name, "compat")
	testing.expect_value(t, ui.caps.mode, ui.Color_Mode.Ansi16)
	testing.expect(t, ui.caps.ascii)
...
test_caps_force_dumb :: proc(t: ^testing.T) {
	ui.caps_init("dumb")
	testing.expect_value(t, ui.caps.name, "dumb")
	testing.expect_value(t, ui.caps.mode, ui.Color_Mode.None)
	testing.expect(t, !ui.caps.alt_screen)
...
test_caps_force_full :: proc(t: ^testing.T) {
	ui.caps_init("full")
	testing.expect_value(t, ui.caps.name, "full")
	testing.expect_value(t, ui.caps.mode, ui.Color_Mode.Truecolor)
	testing.expect(t, !ui.caps.ascii)
}
...
test_caps_force_256 :: proc(t: ^testing.T) {
	ui.caps_init("256")
	testing.expect_value(t, ui.caps.name, "256")
	testing.expect_value(t, ui.caps.mode, ui.Color_Mode.Ansi256)
	testing.expect(t, !ui.caps.ascii)
